...
The post-change check showed that Active Directory replication remained healthy after the PC27 firewall configuration was applied.
...
Active Directory replication remained healthy in the retained post-change check, and the broader firewall rollout was intentionally deferred until further firewall study and testing are completed.
