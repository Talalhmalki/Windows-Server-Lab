...
The post-change check showed that Active Directory replication remained healthy after the pilot hardening configuration was applied.
...
The post-hardening validation showed that the tested VIREXON services remained operational after the security changes. DNS, DHCP, departmental file access, Group Policy processing, RSAT administration, Active Directory Domain Services, DNS Server, Netlogon, DFS Replication, and Active Directory replication all remained operational.
